...
// const news = "https://www.boston.com/";
// const sports = "https://www.boston.com/category/sports";
// const localnews = "https://www.boston.com/tag/local-news/";
// const sections = [news, sports, localnews];
  ...
  dataArticle.findOne({}, function (err, foundList) {
    if (!err) {
      if (!foundList) {
        ...
        d.save();
      } else console.log("Not Added! Already there");
    }
  });
})();
